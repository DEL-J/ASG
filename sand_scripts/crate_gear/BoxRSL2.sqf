...
_this addmagazinecargoglobal ["UGL_FlareYellow_F", 18];
_this addmagazinecargoglobal ["1Rnd_Smoke_Grenade_shell", 18];
_this addmagazinecargoglobal ["1Rnd_SmokeYellow_Grenade_shell", 18];
_this addmagazinecargoglobal ["1Rnd_SmokeGreen_Grenade_shell", 18];
